...
require "/Users/baiyilan/Research/Luzhi/docker/OligoFormer/off-target/pita/lib/libfile.pl";
...
while(@ARGV)
{
  ...
  {
    die("/Users/baiyilan/Research/Luzhi/docker/OligoFormer/off-target/pita/lib/body.pl: Bad argument '$arg' given.  Use --help for help.");
  }
}
...
{
   $tmp_file = 'tmp_' . time . '.' . rand() . './Users/baiyilan/Research/Luzhi/docker/OligoFormer/off-target/pita/lib/body.pl';
...
__DATA__
Syntax: /Users/baiyilan/Research/Luzhi/docker/OligoFormer/off-target/pita/lib/body.pl BEG END < FILE
...
-f:               Allow giving BEG and END as fractions of number of lines in file (for example /Users/baiyilan/Research/Luzhi/docker/OligoFormer/off-target/pita/lib/body.pl 4 -0.2)
